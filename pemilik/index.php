...
$result = mysqli_query($conn, "select *, DATE_FORMAT(tgl_lahir, '%d %M %Y') as tgl_lahir2 from tb_user where username='$session_id'") or die('Error In Session');
              ...
              <div class="row content-panel">
                ...
                <div class="col-md-4 profile-text">
                  ...
                  <ul class="nav pull-right top-menu">
                    <div>
                      <li><a class="fa fa-print logout" href="#" name="profile" data-toggle="modal" data-target="#cetak"> Cetak Laporan</a></li>
                    </div>
                  </ul>
                </div>
                <!-- Page Heading -->
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="cetak_laporan.php" enctype="multipart/form-data" method="POST">
                  <fieldset>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" name="cetak" id="cetak" class="btn btn-primary fa fa-edit"> Cetak</button>
                    </div>
                  </fieldset>
                </form>
              </div>
